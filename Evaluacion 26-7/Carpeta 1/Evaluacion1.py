...
#1.- Escribir un programa para una empresa que tiene salas de juegos para todas las edades
...
#1.- Escribir un programa en el que se pregunte al usuario por una frase y una letra, y 
