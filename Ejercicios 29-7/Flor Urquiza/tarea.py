...
#3.- Crea un bucle while que se ejecute hasta que x valga 0 con decrementos de 1 y que
# muestre en cada ejecución esta frase con el valor de ejecución correspondiente: 'El valor del bucle es 10'...
...
#4.- Crea un bucle for que itere la siguiente tupla y muestre una frase como esta
# en cada iteración: 'El color es: ' + color + '.'

color= ["rosa", "violeta", "azul", "verde"]
